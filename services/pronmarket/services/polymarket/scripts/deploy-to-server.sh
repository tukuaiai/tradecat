...
echo ""
echo "Next steps:"
echo "1. SSH to server: ssh root@174.138.48.217"
echo "2. Configure .env: nano /root/.projects/polymarket/bot/.env"
echo "3. Start bot: cd /root/.projects/polymarket/bot && node src/bot.js"
echo ""
REMOTE_SCRIPT
